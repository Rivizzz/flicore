(() => {
    ...
    const tipsContainer = document.querySelector(".map-search__results");
    if (tipsContainer) if (document.documentElement.clientWidth > 1300) {
        const tipBody1 = document.getElementById("tipBody1");
        tipBody1.style.display = "flex";
        tippy_esm("#propertyButton1", {
            content: tipBody1,
            theme: "translucent",
            placement: "top-start"
        });
        const tipBody2 = document.getElementById("tipBody2");
        tipBody2.style.display = "flex";
        tippy_esm("#propertyButton2", {
            content: tipBody2,
            theme: "translucent",
            placement: "top-start"
        });
        const tipBody3 = document.getElementById("tipBody3");
        tipBody3.style.display = "flex";
        tippy_esm("#propertyButton3", {
            content: tipBody3,
            theme: "translucent",
            placement: "top-start"
        });
        const tipBody4 = document.getElementById("tipBody4");
        tipBody4.style.display = "flex";
        tippy_esm("#propertyButton4", {
            content: tipBody4,
            theme: "translucent",
            placement: "top-start"
        });
        const tipBody5 = document.getElementById("tipBody5");
        tipBody5.style.display = "flex";
        tippy_esm("#propertyButton5", {
            content: tipBody5,
            theme: "translucent",
            placement: "top-start"
        });
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) {
            ...
            new core(".property-desc__slider", {
    ...
    document.addEventListener("click", (function(e) {
        const targetElement = e.target;
        if (targetElement.closest(".search__icon") || targetElement.closest(".search__btn") || targetElement.closest(".search__txt")) document.documentElement.classList.add("search-open"); else if (!targetElement.closest(".search")) {
            document.documentElement.classList.remove("search-open");
            if (document.querySelector("._form-error")) {
                const searchErrors = document.querySelectorAll("._form-error");
                searchErrors.forEach((searchError => {
                    searchError.classList.remove("_form-error");
                }));
            }
        }
    }));
    ...
    function windowLoad() {
        ...
        function digitsCountersAnimate(digitsCounter) {
            ...
            const step = timestamp => {
                ...
                digitsCounter.innerHTML = Math.floor(progress * (startPosition + startValue)).toLocaleString("en-US");
